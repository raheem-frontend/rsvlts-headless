...
export default function ShopByProduct({ title, collections }) {
  return (
    <section className="py-[32px] px-[16px]">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-[15px] mx-auto mt-[30px]">
        {collections.map((collection) => (
          ...
          >
            ...
            <h3 className="absolute inset-0 flex items-center justify-center text-white font-bold sm:text-[28px] text-[20px] p-[15px] text-center uppercase">
              {collection.title}
            </h3>
          </Link>
        ))}
